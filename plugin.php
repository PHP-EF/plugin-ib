	...
	public function generateSecurityReport($StartDateTime,$EndDateTime,$Realm,$UUID,$unnamed,$substring) {
		...
		if (is_array($UserInfo) && isset($UserInfo['Error'])) {
			...
			$CubeJSRequests = array(
				...
				'Devices' => '{"measures":["PortunusTopAggUserDevices.deviceCount"],"dimensions":["PortunusTopAggUserDevices.device_name","PortunusTopAggUserDevices.user","PortunusTopAggUserDevices.network","PortunusTopAggUserDevices.dhcp_fingerprint","PortunusTopAggUserDevices.os_version","PortunusTopAggUserDevices.mac_address"],"timeDimensions":[{"dimension":"PortunusTopAggUserDevices.timestamp","dateRange":["2025-01-18T11:00:00.000","2025-01-19T10:59:59.000"]}],"filters":[{"member":"PortunusTopAggUserDevices.type","operator":"equals","values":["1"]}],"limit":"10000","ungrouped":false}',
